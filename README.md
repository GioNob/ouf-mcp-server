...
- Go 1.25.0 and official MCP Go SDK v1.7.0 are pinned.
...
Run `scripts/verify.sh` with Go 1.25.0. The same source builds the `mcp-server` and reserved `maintenance-worker` process roles.
