...
class ManagedUploadEnvironmentTests(unittest.TestCase):
    def test_exact_opt_in_and_probe_do_not_change_original_environment(self):
        ...
        self.assertEqual(expected_environment(original, "enabled", "https://files.example.org"),
    ...
    def test_origin_gate_rejects_unreviewed_or_network_local_targets(self):
        ...
        for mode, origin in (("enabled", None), ("probe", "https://files.example.org"),
        ...
        with self.assertRaises(ValueError):
            expected_environment([*original, "MCP_HOST_FILE_ORIGINS=https://old.example.org"],
                                 "enabled", "https://files.example.org")
